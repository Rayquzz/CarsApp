...
public class ExpressCostStrategy : IServiceCostStrategy
{
    ...
    public CostEstimate Calculate(ServiceOrder order)
    {
        ...
        var urgentFee = baseCost * 0.25m;
        rules.Add("A fost aplicata taxa de urgenta de 25%.");

        var adjustments = urgentFee;
